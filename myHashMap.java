...
class myHashMap<K,V> {
    ...
    public V remove(K key) {
        ...
        //No need to care about adjusting the hashmap buckets because size is not increasing.
     ...
     *               else null if not found.
     */
    //What's up with the @return??? This is a boolean method.
